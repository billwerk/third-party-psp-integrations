...
public class SendUpgradePreauthCommand : IRequest<Result<PreauthResponseDto, PaymentErrorDto>>
{
    public SendUpgradePreauthCommand(PreauthRequestDto preauthRequestDto, PaymentProvider paymentProvider, NotEmptyString pspSettingsId)
    {
